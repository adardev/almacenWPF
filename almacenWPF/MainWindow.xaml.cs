...
namespace almacenWPF {
    public partial class MainWindow : Window {
        ...
        private async void MainWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            var key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl2aGt3aGlydnphdnBicGF4eHJiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDczNjMwMDIsImV4cCI6MjA2MjkzOTAwMn0.7A9YtrIoS-W0tZ-q8VJnTPkiSCf6fhBtY046sSbltLs"; // tu clave
        ...
        private async void login(object sender, RoutedEventArgs e)
        {
            ...
            if (response.Models.Count > 0) {
                ...
                this.Close(); // opcional: cierra la ventana de login
